...
public class HomePageFragmentForAdmin extends Fragment {
    ...
    public HomePageFragmentForAdmin() {
...
//        String layout = menuCard.getProps().get(MenuCardPropEnum.LAYOUT);
    ...
    private void setMainLogoImage() {
        ...
        ImageUtil.loadImageFromStorageBySkippingCache(this.getActivity(), imagePath, "Logo Big Image", logoImage);
...
//        logoImage.setBackground(d);
    ...
    private void initialize() {
        ...
        if (menuCardId != null) {
            menuCardAdminDao.getCardWithButtonsAndActions(menuCardId, new OnResultListener<MenuCard>() {
                @Override
