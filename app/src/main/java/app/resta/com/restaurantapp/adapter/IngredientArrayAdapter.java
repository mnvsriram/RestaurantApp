...
public class IngredientArrayAdapter extends ArrayAdapter<Ingredient> {
    ...
    public IngredientArrayAdapter(Activity activity, int textViewResourceId, Ingredient[] ingredientArray, View.OnClickListener buttonOnClickListener) {
        super(activity, textViewResourceId, ingredientArray);
        this.activity = activity;
        this.data = ingredientArray;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.delete.setTag(ingredient);
        showIngredientsImageInGrid(ingredient, holder.image);
    ...
    private void showIngredientsImageInGrid(final Ingredient ingredient, ImageView imageView) {
        final ImageView imageButton = imageView;
        StorageReference image = storageRef.child(ingredient.getImage());
        GlideApp.with(activity)
                ...
                .listener(new RequestListener<Drawable>() {
                              ...
                              public boolean onLoadFailed(@android.support.annotation.Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                                  Log.i("Ingredient", "No image found for " + ingredient.getName() + " in storage");
                                  return false;
                              }
